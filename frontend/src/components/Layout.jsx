...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <header className="bg-blue-600 text-white px-4 py-3 shadow-lg flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center gap-2">
          <ShoppingCart size={22} />
          <span className="font-bold text-lg tracking-tight">POS Villanueva</span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            title="Cerrar sesión"
            className="p-1.5 rounded-lg hover:bg-blue-500 transition-colors text-blue-200 hover:text-white"
          >
            <LogOut size={18} />
          </button>
        </div>
